...
def run_train(args, writer, accelerator):
    ...
    print("dataset")
    # 生成tensordataset
    train_dataset = processor.create_dataset(examples)
    print("dataloader")
    # 生成dataset
    ...
    trainer.train(train_data=train_dataloader, seed=args.seed)
...
def main():
    ...
    # store path
    parser.add_argument("--output_path", default="checkpoint.pth", type=str, help="the store path of outputs of training.")
